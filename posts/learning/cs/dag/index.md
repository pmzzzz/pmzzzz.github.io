...
{{< image src="dag.png" caption="计算图实例">}}
以下几个问题可以引出计算图：
- 如何在系统中统一表示神经网络？
- 如何实现自动求导？
- 如何对神经网络进行化简、合并、变换？
...
{{< image src="train_math.png" caption="训练流程数学表示">}}
...
{{< image src="vector_Jacobian.png" caption="vector-Jacobian的乘积">}}
